...
COMMANDS = (
    ...
    Command("/todo", "Manage session todos (add/done/list)", "Context & tools"),
    Command(
        "/cost",
        "What this session cost, from the provider's own accounting",
        "Context & tools",
    ),
    Command("/search", "Web search (DuckDuckGo/Brave)", "Context & tools"),
    Command("/tasks", "List/create/update session tasks", "Context & tools"),
    Command("/spawn", "Spawn a specialist agent", "Specialists"),
    Command("/context", "What is filling the context window", "Context & tools"),
    Command("/waves", "Run multi-agent wave execution", "Specialists"),

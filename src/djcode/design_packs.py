...
_PACKS = (
    (
        ...
        "Prioritize decisions, current data and drill-down paths.",
    ),
    ("settings", "Settings and preferences", "Make scope, saved state and risky changes explicit."),
    (
        "command-palette",
        "Command palette",
        "Search and execute commands with predictable keyboard behavior.",
    ),
    (
        "onboarding-auth",
        "Onboarding and authentication",
        "Connect an account with reversible steps and honest capability checks.",
    ),
    (
        "data-table",
        "Data table",
        "Compare records with accessible sorting, filtering and selection.",
    ),
    (
        "usage-billing",
        "Usage and billing",
        "Explain consumption, periods, estimates and paid changes clearly.",
    ),
    (
        "empty-error",
        "Empty and error states",
        "Distinguish absence, filtering, permissions and recoverable failures.",
    ),
)
